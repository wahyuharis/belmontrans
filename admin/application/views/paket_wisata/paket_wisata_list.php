<div class="card">
    <div class="card-body">
        <a class="btn btn-primary" href="<?= base_url('paket_wisata/add') ?>">Add</a>
        <br>
        <br>
        <table id="dtt_tables" class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th><?= label2("nama_wisata") ?></th>
                    <th><?= label2("foto") ?></th>
                    <th><?= label2("destinasi") ?></th>
                    <th><?= label2("harga") ?></th>
                </tr>
            </thead>
            <tbody>
...
<script>
    $(document).ready(function() {
        var table = $('#dtt_tables').DataTable({
            ...
            "order": [[2, 'asc']],
            "processing": true,
            "ajax": '<?= base_url('paket_wisata/datatables') ?>',
        ...
        function delete_handler() {
            $('.delete_btn').click(function(e) {
                ...
                bootbox.dialog({
                    title: 'Delete',
                    message: '<p>Yakin Menghapus Paket Wisata <b>"' + row_data + '"</b> ?</p>',
                    onEscape: true,
                    backdrop: true,
                    buttons: {
                        ya: {
