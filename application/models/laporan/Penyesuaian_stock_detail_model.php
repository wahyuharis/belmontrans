...
class Penyesuaian_stock_detail_model extends CI_Model
{
    ...
    function sql_list()
    {
        ...
        if (strlen($this->input->get('tanggal')) > 0 and strlen($this->input->get('tanggal2')) > 0) {
            ...
            $filter_tanggal = " penyesuain_stock.tanggal between  '" . $this->db->escape_str($tanggal) . " 00:00:00' and '" . $this->db->escape_str($tanggal2) . " 23:59:59' ";
        }
        ...
        $sql = "SELECT  
                ...
                LEFT JOIN (SELECT  
                penyesuaian_stock_detail.id_item,
                sum(penyesuaian_stock_detail.qty_selisih) AS qty_disesuaikan,
                SUM( penyesuaian_stock_detail.qty_selisih * penyesuaian_stock_detail.hpp ) AS hpp_disesuaikan
                ...
                GROUP BY penyesuaian_stock_detail.id_item) AS tb ON tb.id_item=m_item.id_item
